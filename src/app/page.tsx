...
export default function Home() {
  ...
  return (
    <div className="flex flex-col w-full bg-white overflow-hidden">
      ...
      <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden bg-[#001F3F]">
        {/* Video Element */}
        <video 
          autoPlay 
          loop 
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-[#001F3F]/80 via-[#001F3F]/40 to-[#001F3F]/80" />
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl mx-auto flex flex-col items-center gap-10 reveal">
          <div className="flex flex-col items-center gap-4">
            <div className="w-12 h-[1px] bg-[#C5A059] mb-2" />
            <span className="text-[#C5A059] font-medium tracking-[0.4em] text-[10px] uppercase">Curadoria Genética de Elite</span>
          </div>

          <h1 className="font-serif text-5xl md:text-8xl font-bold tracking-tight text-white leading-[1.1]">
            Onde a Excelência <br/>
            <span className="italic text-[#C5A059]">Encontra a Alma</span>
          </h1>
        ...
        {/* The shape-fill here should be WHITE to blend with next section, and fill the BOTTOM part */}
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="relative reveal">
              {/* Image with background-less style (floating) */}
              <div className="relative aspect-square md:aspect-[4/5] overflow-visible rounded-sm">
                 <div className="absolute inset-x-0 bottom-0 top-1/4 bg-zinc-50 rounded-3xl -z-10 bg-[radial-gradient(circle_at_50%_100%,rgba(197,160,89,0.1)_0%,transparent_70%)]" />
              ...
              <div className="absolute -top-10 -right-10 w-40 h-40 bg-[#C5A059]/5 rounded-full blur-3xl" />
            </div>
            
            <div className="space-y-8 reveal" style={{ transitionDelay: "200ms" }}>
              <div className="flex items-center gap-4">
                <div className="w-8 h-[1px] bg-[#C5A059]" />
                <span className="text-[#C5A059] font-bold text-[10px] tracking-[0.4em] uppercase">Nossa Essência</span>
              </div>
              <h2 className="font-serif text-4xl md:text-6xl text-[#001F3F] leading-tight">Uma Abordagem <br/> Minimalista e <br/> Decidida.</h2>
              ...
              <div className="space-y-6 pt-8">
                {[
                  ...
                  <div key={i} className="flex gap-6 pb-6 border-b border-zinc-100 group hover:border-[#C5A059]/30 transition-colors">
                    <span className="text-[#C5A059] font-bold text-[10px] tracking-[0.2em] pt-1">{item.label}</span>
      ...
      {/* Featured CTA: Navy with Top Waves */}
      <section className="relative py-48 bg-[#001F3F] overflow-hidden text-center">
        {/* Waves Transition from Philosophy (White -> Navy) */}
        {/* The shape-fill here should be WHITE to blend with previous section, and fill the TOP part */}
        ...
        <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-[#C5A059]/5 rounded-full blur-[120px] -ml-64 -mb-64" />
      </section>
    </div>
  );
}
